...
// at the city embedded in the URL in the map_canvas container of an html
// document.
...
// Description: Draw a google map centered at the cityInfo['center'] of the city.
...
// Description:	A function to import data from adminData/97303/gpa.csv and 
...
function drawCityData(cityname, cityInfo)
{
	...
	d3.csv("adminData/auto/" + cityname + "/gpa.csv", function(data) {
      ...
      .enter().append("svg:text")
        ...
        .attr("y", function(d) { return (h - (d.meanGpa * h / maxy)); })
        .attr("dx", 55)
        .attr("dy", ".71em")
